          ...
          <Box px="2em" width={1/3} key={index}>
            <Box bg="lightGray" my="2em" borderRadius="5em" py="1.5em">
              <Flex alignItems="center">
                <Box width={3/10} textAlign="right" borderRight="1px solid" pr="1em" py="0.5em">
                  <Text.inline fontSize="2em" color={color}>{value}</Text.inline>
                  <Text.inline pl="0.25em">{unit}</Text.inline>
                </Box>
                <Box width={7/10} whiteSpace="pre" borderLeft="1px solid" pl="1em" py="0.5em">
        ...
        <PatternBg py="2em">
          <Container>
            <Box fontSize="1.5em" borderBottom="1px solid" py="0.75em">
              <Text letterSpacing={2} fontWeight="bold">案件情況</Text>
            </Box>
            <Module datas={primarys} color="orange2" my="2em" />
            <LineBg>
              <Box height="2em" />
            </LineBg>
            <Module datas={secondarys} color="darkBlue" />
          </Container>
        </PatternBg>
      </Layout>
    )
